...
class Client(models.Model):
    ...
    industry = models.ForeignKey(Industry, on_delete=models.SET_NULL, null=True, related_name='clients')
...
class Testimonial(models.Model):
    """Client testimonials"""
    client = models.ForeignKey(Client, on_delete=models.CASCADE, related_name='testimonials', null=True, blank=True)
...
class JobApplication(models.Model):
    ...
    # Documents
    resume = models.FileField(upload_to='applications/resumes/', validators=[FileExtensionValidator(['pdf', 'doc', 'docx'])])
...
class EmployerInquiry(models.Model):
    ...
    industry = models.ForeignKey(Industry, on_delete=models.SET_NULL, null=True, related_name='inquiries')
...
class MediaPhoto(models.Model):
    ...
    album = models.ForeignKey(MediaAlbum, on_delete=models.CASCADE, related_name='photos')
