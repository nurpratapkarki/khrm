...
router.register(
    r"job-applications", views.JobApplicationViewSet, basename="job-application"
)
router.register(
    r"employer-inquiries", views.EmployerInquiryViewSet, basename="employer-inquiry"
)

# Training
router.register(
    r"training-courses", views.TrainingCourseViewSet, basename="training-course"
)
router.register(
    r"training-facilities", views.TrainingFacilityViewSet, basename="training-facility"
)
...
# Legal
router.register(
    r"privacy-policy", views.PrivacyPolicyViewSet, basename="privacy-policy"
)
router.register(
    r"terms-of-service", views.TermsOfServiceViewSet, basename="terms-of-service"
)

# FAQ & Contact
router.register(r"faqs", views.FAQViewSet, basename="faq")
router.register(
    r"contact-messages", views.ContactMessageViewSet, basename="contact-message"
)
...
router.register("japan-programs", views.JapanProgramViewSet, basename="japan-program")
...
urlpatterns = [
    # Routes are already mounted under /api/ in project urls, so expose the
    # router at the root here to avoid a double /api/api/ prefix.
