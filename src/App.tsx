...
import JapanProgramDetailPage from '@/pages/JapanProgramDetailPage';
      ...
      <div className="flex flex-col min-h-screen">
        ...
        <main className="grow">
          ...
          <Routes>
            ...
            <Route path="/japan/programs/:id" element={<JapanProgramDetailPage />} />
            ...
            <Route path="/license" element={<LicenseDetailPage />} />
