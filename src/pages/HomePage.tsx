      ...
      <section className="py-24">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {data?.featured_jobs.map((job, index) => (
              <motion.div
                key={job.id}
      ...
      <section className="py-24 bg-linear-to-r from-primary to-primary/80 text-primary-foreground">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button size="lg" variant="outline" className="text-lg px-8 bg-accent-gold border-primary-foreground/20 hover:bg-primary-foreground/10" asChild>
